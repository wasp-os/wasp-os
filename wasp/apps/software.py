...
class SoftwareApp():
    ...
    def foreground(self):
        ...
        self.db = (
                ('accel', wasp.widgets.Checkbox(0, 0, 'Acceleration')),
                ('alarm', wasp.widgets.Checkbox(0, 40, 'Alarm')),
                ('calc', wasp.widgets.Checkbox(0, 80, 'Calculator')),
                ('chrono', wasp.widgets.Checkbox(0, 120, 'Chrono')),
