...
class MusicPlayerApp(object):
    ...
    def _fill_space(self, key):
        if key == "top":
            wasp.watch.drawable.fill(x=0, y=0, w=DISPLAY_WIDTH, h=CENTER_AT)
        elif key == "down":
            wasp.watch.drawable.fill(
                x=0,
                y=CENTER_AT + ICON_SIZE,
                w=DISPLAY_WIDTH,
    ...
    def foreground(self):
        ...
        wasp.system.request_event(wasp.EventMask.SWIPE_LEFTRIGHT | wasp.EventMask.TOUCH)
